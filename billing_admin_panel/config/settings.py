...
BILLING_SERVICE_URL=f"http://{os.getenv('BILLING_SERVICE_HOST','billing-service')}:{os.getenv('BILLING_SERVICE_PORT','8000')}"
INTERNAL_BILLING_SECRET_KEY=os.getenv("INTERNAL_BILLING_SECRET_KEY","INTERNAL_BILLING_SECRET_KEY")
#
