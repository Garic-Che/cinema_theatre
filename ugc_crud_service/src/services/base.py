...
class BookmarkServiceABC(
    CUDServiceABC[Bookmark, UpdateModel], ReadServiceABC[Bookmark]
):
    pass
...
class CommentServiceABC(
    CUDServiceABC[Comment, CommentUpdateModel], ReadServiceABC[Comment]
):
    @abstractmethod
