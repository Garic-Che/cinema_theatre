...
class Notification(BaseModel):
    to_id: str = ""  # id пользователя, которому отправляется уведомление или имя рассылки ("all")
    send_by: str = ""  # способ отправки уведомления ("email", "websocket")
    content_key: str = ""  # ключ контента / тип шаблона
