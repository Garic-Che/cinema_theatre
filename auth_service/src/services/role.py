...
class RoleService:
    ...
    async def delete_role(self, role_id: str) -> str | None:
        """Удаление роли."""
        try:
            # удаляем роль
    ...
    async def assign_role(self, role_id: str, user_id: str) -> str | None:
    ...
    async def revoke_role(self, role_id: str, user_id: str) -> str | None:
